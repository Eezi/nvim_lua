-- Mappings.
-- See `:help vim.diagnostic.*` for documentation on any of the below functionslocal
...
local on_attach = function(client, bufnr)
  ...
  vim.keymap.set('n', '<space>e', function() vim.lsp.buf.format { async = true } end, bufopts)
end
